document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("btn-cse").addEventListener("click", () => showCourses('CSE'));
    document.getElementById("btn-wdd").addEventListener("click", () => showCourses('WDD'));
...
function displayCourses(courseList) {
    ...
    courseList.forEach(course => {
        ...
        p.dataset.credits = course.credits;
